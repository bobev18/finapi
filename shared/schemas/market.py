...
class MarketSnapshot(BaseModel):
    ...
    This is the canonical definition shared across all FinAPI services.
    Service-local schemas/market.py files re-export this class so that
    internal import paths remain stable while schema evolution is managed
    in a single place.
    """
